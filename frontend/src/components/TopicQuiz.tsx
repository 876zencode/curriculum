      ...
      <CardContent className="space-y-3">
        ...
        {isError && (
          <p className="text-xs text-amber-600">
            Quiz not available yet. It may need to be generated by an admin.
          </p>
        )}

        {!isLoading && !isFetching && !isError && questions.length === 0 && (
          <p className="text-xs text-muted-foreground">No quiz available yet. Check back after it’s generated.</p>
        )}
        ...
        {!isLoading && !isFetching && questions.length > 0 && currentQuestion && (
          <div className="space-y-3">
            <div className="border rounded-lg p-3 space-y-2 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm">
              ...
              {answers[activeIndex] === currentQuestion.correct_answer && currentQuestion.explanation && (
